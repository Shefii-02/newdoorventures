    ...
    public function boot(): void
    {
        ...
        DashboardMenu::default()->beforeRetrieving(function (DashboardMenuSupport $menu) {
            ...
            // $menu
                ...
                // )
                // ;  
                $menu->removeItem(['cms-plugins-real-estate-custom-fields','cms-plugins-payments','cms-plugins-faq','cms-core-plugins','cms-core-settings','cms-core-widget','cms-plugins-location']);
        });
