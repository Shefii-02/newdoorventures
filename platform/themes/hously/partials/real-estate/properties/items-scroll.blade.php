        ...
        @foreach($properties as $property)
            <div class="">
                <div class="relative overflow-hidden">
                    <a href="{{ $property->url }}">
                        <img src="{{ RvMedia::getImageUrl($property->image, 'small', false, RvMedia::getDefaultImage()) }}" alt="{{ $property->name }}" class="rounded-xl duration-500">
                    </a>
                ...
                <div class="p-6">
                    ...
                    <ul class="flex flex-wrap gap-3 items-center justify-between pt-4 ps-0 mb-0 list-none">
                        <li>
                            ...
                            <p class="text-lg font-semibold">{{ shorten_price($property->price) }} {{-- , $property->currency) --}}</p>
                        </li>
                        <li>
