<div>
    ...
    <div class="relative mt-2 filter-search-form filter-border">
        ...
        <input name="k" type="text" id="keyword-{{ $type }}" class="border-0 form-input filter-input-box bg-gray-50 dark:bg-slate-800" autocomplete="off" placeholder="{{ __('Search your '.ucfirst('projects'). ' or Area') }}" value="{{ BaseHelper::stringify(request()->query('k')) }}">
