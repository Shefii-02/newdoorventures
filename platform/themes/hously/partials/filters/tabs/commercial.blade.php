            ...
            <div x-show="openCommercial" x-transition x-cloak>
                ...
                <div class="mt-3">
                    <div class="flex space-x-4 mb-4 gap-8">
                        <span role="button" @click="activeTab = (activeTab === 'budget_commercial' ? '' : 'budget_commercial')"
                            :class="{ 'font-bold tab-active': activeTab === 'budget_commercial' }"
                            class="text-dark border rounded-3xl px-4 fs-6">
                            Budget
                            <i :class="activeTab === 'budget_commercial' ? 'mdi mdi-chevron-up' : 'mdi mdi-chevron-down'"></i>
                        </span>

                        <span role="button" @click="activeTab = (activeTab === 'bedroom_commercial' ? '' : 'bedroom_commercial')"
                            :class="{ 'font-bold tab-active': activeTab === 'bedroom_commercial' }"
                            class="text-dark border rounded-3xl px-4 fs-6">
                            Bedroom
                            <i :class="activeTab === 'bedroom_commercial' ? 'mdi mdi-chevron-up' : 'mdi mdi-chevron-down'"></i>
                        </span>
                    ...
                    <div>
                        <div x-show="activeTab === 'budget_commercial'" class="p-4 rounded-lg" x-cloak>
                            {!! Theme::partial('filters.price-range', compact('type')) !!}
                        </div>
                        <div x-show="activeTab === 'bedroom_commercial'" class="p-4 rounded-lg" x-cloak>
