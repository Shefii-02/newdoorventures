    ...
    <div class="wrapper">
      <div class="price-input size-input-{{$type}}">
        ...
        <span class="price-range-values d-flex gap-2 mb-12">
            <span class="min">0 sq.ft.</span> - <span class="max">4000 sq.ft.</span>
        </span>
        <input name="min_square" style="display:none" type="number" id="min-size" value="0" class="border-0 form-input filter-input-box bg-gray-50 dark:bg-slate-800" placeholder="{{ __('Min size') }}">
        <input name="max_square" style="display:none" type="number" id="max-size" value="0" class="border-0 form-input filter-input-box bg-gray-50 dark:bg-slate-800" placeholder="{{ __('Max size') }}">
      ...
      <div class="size-range-input size-input-{{$type}}" >
          <div class="position-relative">
            <input type="range" data-typeval="{{$type}}"  title="0 sq.ft." class="range-min" min="0" max="4000" value="0" step="300">
          </div>
            <div class="position-relative">
        <input type="range" data-typeval="{{$type}}" title="0 sq.ft." class="range-max" min="0" max="4000" value="4000" step="300">
        </div>
      </div> 
    </div>
