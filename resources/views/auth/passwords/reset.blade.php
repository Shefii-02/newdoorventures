            ...
            <div class="flex justify-center">
                <div
                    ...
                    <div class="grid grid-cols-1">
                        <p class="mb-6 text-slate-400 text-sm text-center">Enter new password</p>
                        <form class="text-start" method="POST" action="{{ route('user.forget-password.send') }}">
                            @csrf
                            <div class="grid grid-cols-1">
                                <div class="mb-4">
                                    <label class="font-medium text-sm" for="email">New Passsword:</label>
                                    <input id="password" name="password" type="email"
