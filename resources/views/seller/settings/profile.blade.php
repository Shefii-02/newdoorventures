                        ...
                        <div class="items-center  text-[#202142]">
                                ...
                                <div class="flex items-center ">
                                    ...
                                    <div class="w-2/4">
                                        <img class="object-cover  w-20 h-20 p-1 rounded-full ring-2 ring-indigo-300 dark:ring-indigo-500"
                                            src="{{ auth('account')->user()->avatar_url }}" id="imagePreview"
                                            alt="Bordered avatar">
                                    </div>
                                    <div class="w-2/4">
                            ...
                            <div
                                ...
                                <div class="w-full">
                                    ...
                                    <input type="text" id="first_name" name="first_name"
                                        ...
                                        placeholder="Your first name" value="{{ auth('account')->user()->first_name }}">
                                    @error('first_name')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <input type="text" id="last_name" name="last_name"
                                        class="bg-indigo-50 border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 "
                                        placeholder="Your last name" value="{{ auth('account')->user()->last_name }}">
                                    @error('last_name')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-2 sm:mb-6">
                                ...
                                <input type="email" id="email" name="email" readonly
                                    class="bg-indigo-50 border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 "
                                    placeholder="your.email@mail.com" value="{{ auth('account')->user()->email }}">
                                @error('email')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-2 sm:mb-6">
                                ...
                                <input type="text" id="phone" name="phone"
                                    class="bg-indigo-50 border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 "
                                    placeholder="" value="{{ auth('account')->user()->phone }}">
                                @error('phone')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
