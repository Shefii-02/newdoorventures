                                            ...
                                            <div class="bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-4 md:p-5">
                                                    <div class="d-flex justify-between">
                                                        <div>
                                                            <h3 class="text-xl font-medium text-dark-900 dark:text-white">
                                                                How to get Address based latitude and longitude</h3>
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div x-show="propertyType === 'under-construction'"
                                                                ...
                                                                <div class="mt-4">
                                                                    ...
                                                                    <span class="text-sm text-gray">Select the month and
                                                                        year
                                                                        when
