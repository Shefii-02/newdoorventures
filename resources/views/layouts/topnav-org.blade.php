            ...
            <ul class="buy-button list-none mb-0">
                ...
                @if(RealEstateHelper::isLoginEnabled())
                    ...
                    <li class="hidden mb-0 sm:inline ps-1">
                        <a href="{{ route('public.account.properties.create') }}" class="text-white rounded-full btn bg-primary hover:bg-secondary border-primary dark:border-primary" aria-label="{{ __('Add your listing') }}">
                            {{ __('Post your property for free') }}
                        </a>
                    </li>
