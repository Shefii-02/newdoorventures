    ...
    <div style="background-color:#f2f2f7;height:100%;width:100%;display:flex;align-items:center;font-family: 'Google Sans', system-ui;">
        <div style="margin: auto;max-width: 760px;width: 100%;margin-top:4em;margin-bottom:4em;font-size:1.2em;">
            <div style="text-align: center;margin-bottom:2rem">
                <img width="200" src="{{ url('/assets/img/logo/logo.png') }}" alt="">
            </div>
            ...
            <div style="text-align: center;margin-top: 3em; ">
                ...
                <div>© {{ date('Y') }} {{ str_replace('-',' ', env('APP_NAME')) }} | <a href="{{ url('/contact-us') }}" style="text-decoration: none;">Contact us</a></div>
            ...
            <div style="text-align: center;">
                <small>This is an automated email notification, please do not reply to this email, if you have any concerns, <a style="text-decoration: none;" href="{{ url('/contact-us') }}">contact us</a></small>
            </div>
            @endif
        </div>
    </div>
