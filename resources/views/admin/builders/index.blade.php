                ...
                <form class="row">
                    <div class="col-lg-4">
                        ...
                        <div class="relative mt-1 px-3">
                            ...
                            <input type="text" name="search" id="table-search" autocomplete="off"
                                        ...
                                        <div class=" w-2/12 text-end">
                                            <div class=" btn-group">
                                                ...
                                                @if (permission_check('Builder Delete'))
                                                    <form method="POST" id="form_{{ $builder->id }}"
                                                        action="{{ route('admin.builders.destroy', $builder->id) }}">@csrf
                                                        @method('DELETE')</form>
                                                    <button form="form_{{ $builder->id }}" type="button"
