    ...
    <div
        ...
        <nav>
            <ol class="flex flex-wrap items-center gap-2">
                ...
                <li>
                    <a class="flex items-center gap-3 font-medium" href="{{ route('admin.furnishing.index') }}">
                        ...
                        <span class="hover:text-primary">Furnishing</span>
                    </a>
                </li>
        ...
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                <h3 class="font-medium text-black dark:text-dark">
                    {{ isset($furnishing) ? 'Edit Furnishing' : 'Create a Furnishing' }}
                </h3>
            </div>
            
            <!-- Form -->
            <form enctype="multipart/form-data"
                action="{{ isset($furnishing) ? route('admin.furnishing.update', $furnishing->id) : route('admin.furnishing.store') }}"
                method="POST">
                @csrf
                @if (isset($furnishing))
                    @method('PUT')
                ...
                <div class="p-6.5">
                    ...
                    <div class="mb-5 ">
                        <div class="col-lg-6 mb-3">
                            ...
                            <div x-data="{
                                    image: null,
                                    imageUrl: '{{ isset($furnishing) && $furnishing->image_url ? asset($furnishing->image_url) : '' }}',
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" id="name" name="name"
                                value="{{ old('name', $furnishing->name ?? '') }}" 
                        ...
                        <div class="mt-4">
                            <button type="submit"
                                ...
                                {{ isset($furnishing) ? 'Update' : 'Create' }}
                            </button>
                        </div>
                    </div>
            </form>
