    ...
    <div
        ...
        <nav>
            <ol class="flex flex-wrap items-center gap-2">
                ...
                <li>
                    <a class="flex items-center gap-3 font-medium" href="{{ route('admin.rules.index') }}">
                        ...
                        <span class="hover:text-primary">Rules</span>
                    </a>
                </li>
        ...
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                <h3 class="font-medium text-black dark:text-dark">
                    {{ isset($rule) ? 'Edit Rule' : 'Create a Rule' }}
                </h3>
            </div>

            <!-- Form -->
            <form enctype="multipart/form-data"
                action="{{ isset($rule) ? route('admin.rules.update', $rule->id) : route('admin.rules.store') }}"
                method="POST">
                @csrf
                @if (isset($rule))
                    @method('PUT')
                ...
                <div class="p-6.5">
                    ...
                    <div class="mb-5 ">
                        <div class="col-lg-6 mb-3">
                            ...
                            <div x-data="{
                                image: null,
                                imageUrl: '{{ isset($rule) && $rule->image_url ? asset($rule->image_url) : '' }}',
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $rule->name ?? '') }}"
                            ...
                            <div class="d-flex gap-3 mt-2">
                                <div class="form-check">
                                    <input 
                                        ...
                                        value="text" 
                                        id="typeText" 
                                        {{ old('type', $rule->type ?? '') == 'text' ? 'checked' : 'checked' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" 
                                            ...
                                            value="radio"
                                            {{ old('type', $rule->type ?? '') == 'radio' ? 'checked' : '' }}
                                        id="typeRadio">
