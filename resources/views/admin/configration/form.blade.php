        ...
        <div
            ...
            <nav>
                <ol class="flex flex-wrap items-center gap-2">
                    ...
                    <li>
                        <a class="flex items-center gap-3 font-medium" href="{{ route('admin.configration.index') }}">
                            ...
                            <span class="hover:text-primary">Configrations</span>
                        </a>
                    </li>
                    <li class="flex items-center gap-2 font-medium">
                        ...
                        {{ isset($configration) ? 'Edit' : 'Create' }}
                    </li>
                </ol>
            </nav>
        </div>
                    ...
                    <div class="mb-5 ">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" id="name" name="name"
                                value="{{ old('name', $configration->name ?? '') }}" class="form-control" required>
                            @error('name')
