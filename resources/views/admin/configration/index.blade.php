                            ...
                            <div class="flex justify-between items-center gap-3">
                                ...
                                <div class=" w-2/12 2xsm:block md:w-1/12">
                                    <div class="flex justify-between">
                                        <a href="{{ route('admin.configration.edit', $config->id) }}"
                                        ...
                                        <form method="POST" id="form_{{ $config->id }}"
                                            action="{{ route('admin.configration.destroy', $config->id) }}">@csrf
                                            @method('DELETE')</form>
                                        <button form="form_{{ $config->id }}" type="button"
