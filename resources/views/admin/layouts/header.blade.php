...
<header class="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
    <div class="flex flex-grow justify-content-end items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
            ...
            <!-- Hamburger Toggle BTN -->
            <a class="block flex-shrink-0 lg:hidden" href="{{ route('admin.dashboard.index') }}">
                <img src="{{ asset('images/general/logo-dark.png') }}" class="w-15 ms-3" alt="Logo" />
            </a>
        </div>
        ...
        <div class="flex items-center gap-3 2xsm:gap-7">
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                ...
                <div x-show="dropdownOpen"
                    ...
                    <form action="{{ route('admin.logout') }}" id="logout-form" method="POST"> @method('POST') @csrf </form>
