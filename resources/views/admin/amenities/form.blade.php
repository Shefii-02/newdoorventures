    ...
    <div
        ...
        <nav>
            <ol class="flex flex-wrap items-center gap-2">
                ...
                <li>
                    <a class="flex items-center gap-3 font-medium" href="{{ route('admin.amenities.index') }}">
                        ...
                        <span class="hover:text-primary">Amenities</span>
                    </a>
                </li>
        ...
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                <h3 class="font-medium text-black dark:text-dark">
                    {{ isset($amenety) ? 'Edit Amenities' : 'Create a Amenities' }}
                </h3>
            </div>
            
            <!-- Form -->
            <form enctype="multipart/form-data"
                action="{{ isset($amenety) ? route('admin.amenities.update', $amenety->id) : route('admin.amenities.store') }}"
                method="POST">
                @csrf
                @if (isset($amenety))
                    @method('PUT')
                ...
                <div class="p-6.5">
                    ...
                    <div class="mb-5 ">
                        <div class="col-lg-6 mb-3">
                            ...
                            <div x-data="{
                                    image: null,
                                    imageUrl: '{{ isset($amenety) && $amenety->image_url ? asset($amenety->image_url) : '' }}',
