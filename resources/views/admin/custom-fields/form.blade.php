    ...
    <div
        ...
        <nav>
            <ol class="flex flex-wrap items-center gap-2">
                ...
                <li>
                    <a class="flex items-center gap-3 font-medium" href="{{ route('admin.custom-fields.index') }}">
                        ...
                        <span class="hover:text-primary">Custom Fields</span>
                    </a>
                </li>
