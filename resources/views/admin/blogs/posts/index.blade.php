            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div class="border-b border-stroke px-4 pb-2 dark:border-strokedark md:px-6 xl:px-7.5">
                    <div class="flex justify-between items-center gap-x-6">
                        ...
                        <div class="w-1/12 text-center"><span class="font-medium">Category</span></div>
                        ...
                        @forelse ($posts as $key => $post)
                            <div class="flex justify-between items-center gap-x-6">
                                ...
                                <div class="w-2/12 flex justify-center">
                                    <img src="{{ asset('images/' . $post->image) }}" class="w-50 rounded-5">
                                </div>
                                <div class="w-2/12 flex justify-left">
                                ...
                                <div class="w-2/12 text-center">
                                    <span
                                        class="inline-block text-capitalize rounded px-2.5 py-0.5 text-sm font-medium text-white {{ $post->status === 0 ? 'bg-danger' : 'bg-success' }}">
                                        {{ $post->status_html }}
                                    </span>
                                </div>
                                <div class=" w-2/12 text-end">
                                    <div class=" btn-group">
                                        ...
                                        <form method="POST" id="form_{{ $post->id }}"
                                            action="{{ route('admin.blogs.destroy', $post->id) }}">@csrf
                                            @method('DELETE')</form>
                                        <button form="form_{{ $post->id }}" type="button"
