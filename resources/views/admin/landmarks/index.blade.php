                            ...
                            <div class="flex justify-between items-center gap-3">
                                ...
                                <div class=" w-2/12 2xsm:block md:w-1/12">
                                    <div class="flex justify-between">
                                        <a href="{{ route('admin.landmark.edit', $landmark->id) }}"
                                        ...
                                        <form method="POST" id="form_{{ $landmark->id }}"
                                            action="{{ route('admin.landmark.destroy', $landmark->id) }}">@csrf
                                            @method('DELETE')</form>
                                        <button form="form_{{ $landmark->id }}" type="button"
