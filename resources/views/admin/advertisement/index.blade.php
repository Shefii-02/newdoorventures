                            ...
                            <div class="flex justify-between items-center gap-3">
                                ...
                                <div class=" w-2/12 2xsm:block md:w-1/12">
                                    <div class="flex justify-between">
                                        <a href="{{ route('admin.advertisement.edit',$adv->id) }}" class="mx-auto block hover:text-meta-1">
                                        ...
                                        <form method="POST" id="form_{{ $adv->id }}" action="{{ route('admin.advertisement.destroy',$adv->id) }}">@csrf @method('DELETE')</form>
                                        <button form="form_{{ $adv->id }}" type="submit" class="mx-auto block hover:text-meta-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
