            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-dark-500 md:ms-2 dark:text-dark-400">Property
                            Create</span>
                    </div>
                </li>
            </ol>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mx-2 mb-5">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="relative z-0 w-full mb-3 group">
                                                        <label for="projects" class="mt-3 font-medium mb-2"
                                                            id="property_heighlight_name">
                                                            Property heighlight name
                                                            <sup class="text-danger fs-4">*</sup>
                                                        </label>
                                                ...
                                                <div class="section">
                                                    ...
                                                    <div id="availabiltyStaus" x-data="{ propertyType: 'ready-to-move', propertyStatus: '0-1', possessionDate: '' }"
                                                        ...
                                                        <div class="col-lg-12 mb-3 ">
                                                            <h5 class="mb-2 mt-3 font-bold text-black fs-3">
                                                                Availability Status<sup class="text-danger fs-4">*</sup>
                                                            </h5>
                                                        </div>
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div x-show="propertyType === 'under-construction'"
                                                                ...
                                                                <div class="mt-4">
                                                                    ...
                                                                    <span class="text-sm text-dark">Select the month and
                                                                        year
                                                                        when
                                            ...
                                            <div id="pgRules" class="ShowWantedSectionInPg HideUnwantedSectionsInPlot"
                                                style="display: none">

                                                <!-- Occupancy -->
                                                <div class="col-lg-12 mb-3">
                                                    <h5 class="mb-2 my-3  font-bold fs-3 text-black">Occupancy Type <sup
                                                            class="text-danger fs-4">*</sup></h5>
                                                    <div class="flex items-center flex-wrap gap-3 my-3">
                                                        <div class="flex items-center">
                                                            <input type="radio" form="propertyFrom" id="single"
                                                                name="occupancy_type" value="single" checked
                                                        ...
                                                        <div class="flex items-center">
                                                            <input type="radio" form="propertyFrom" id="double"
                                                                name="occupancy_type" value="double"
                                                                class="w-3 h-3 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                                                            <label for="double"
                                                                class="ml-2 text-sm font-medium text-dark-900">Double</label>
                                                        </div>
                                                        <div class="flex items-center">
                                                            <input type="radio" form="propertyFrom" id="triple"
                                                                name="occupancy_type" value="triple"
                                                                class="w-3 h-3 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                                                            <label for="triple"
                                                        ...
                                                        <div class="flex items-center">
                                                            <input type="radio" form="propertyFrom" id="capsule"
                                                                name="occupancy_type" value="capsule"
                                                                class="w-3 h-3 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                                                            <label for="capsule"
                                                ...
                                                <!-- Available For -->
                                                <div class="col-lg-12 mb-3">
                                                    <h5 class="mb-2 my-3 font-bold fs-3 text-black">Available For <sup
                                                            class="text-danger fs-4">*</sup></h5>
                                                    <div class="flex items-center flex-wrap gap-4  my-3">
                                                        <div class="flex items-center">
                                                            <input type="radio" form="propertyFrom" id="male"
                                                                name="available_for" value="male" checked
                                                                class="w-3 h-3 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                                                            <label for="male"
                                                                class="ml-2 text-sm font-medium text-dark-900">Boys</label>
                                                        </div>
                                                        <div class="flex items-center">
                                                            <input type="radio" form="propertyFrom" id="female"
                                                                name="available_for" value="female"
                                                                class="w-3 h-3 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                                                            <label for="female"
                                                                class="ml-2 text-sm font-medium text-dark-900">Girls</label>
                                                        </div>
                                                        <div class="flex items-center">
                                                            <input type="radio" form="propertyFrom" id="any"
                                                                name="available_for" value="any"
                                                                class="w-3 h-3 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                                                            <label for="any"
                                                                class="ml-2 text-sm font-medium text-dark-900">
                                                                Boys & Girls (Coed)</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-12 my-4 ">
                                                    <h5 class="mb-2 mt-3 font-bold fs-3 text-black">
                                                            ...
                                                            <div class="flex flex-wrap">
                                                                <div class="flex items-center me-4 mb-2">
                                                                    ...
                                                                    <label for="unfurnished-radio"
                                                                        class="ms-2 fs-5 font-medium text-dark dark:text-dark">Unfurnished</label>
                                                                </div>
                                                                ...
                                                                <div class="flex items-center me-4 mb-2">
                                                                    ...
                                                                    <label for="semi-furnished-radio"
                                                                        class="ms-2 fs-5 font-medium text-dark dark:text-dark">Semi-Furnished</label>
                                                                </div>
                                                                <div class="flex items-center me-4 mb-2">
                                                                    <input form="propertyFrom" type="radio"
                                                                    ...
                                                                    <label for="furnished-radio"
                                                                        class="ms-2 fs-5 font-medium text-dark dark:text-dark">Furnished</label>
                                                                </div>
                                                    ...
                                                    <div id="NearestLandmarks">
                                                        ...
                                                        <div class="mt-3 bg-body card p-3 " x-data="{
                                                            ...
                                                            <template x-for="(facility, index) in facilities"
                                                                :key="index">
                                                                <div
                                                                    class="col-lg-12 items-center mb-4 position-relative">
                                                                    <div class="row">
                                                                        <!-- Facility Select Box -->
                        ...
                        <div class="mb-5 mx-2">
                            ...
                            <div x-data="{ isModalOpen: false }" class="section mt-5">
                                <div
                                    ...
                                    <h5 class="mt-3 font-bold text-black fs-3 text-dark-700 text-center">Add YouTube
                                        Videos of Your
                                        Property</h5>
