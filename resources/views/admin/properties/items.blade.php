...
@foreach ($properties as $property)
    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
        ...
        <td class="px-2 py-1 text-center">
            ...
            <form method="POST" id="form_{{ $property->id }}" action="{{ route('admin.properties.destroy',$property->id) }}">@csrf @method('DELETE')</form>
            <button form="form_{{ $property->id }}" type="submit" class="mx-auto block hover:text-meta-1 ms-2">
