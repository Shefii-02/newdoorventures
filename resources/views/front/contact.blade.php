                            ...
                            <div class="p-6 bg-white rounded-md shadow dark:bg-slate-900 dark:shadow-gray-700">
                                ...
                                <form method="post" action="{{ route('public.contact.send') }}"
                                    ...
                                    <div class="grid grid-cols-1">
                                        <div class="mb-5 ">
                                            ...
                                            <input name="name" id="name" required type="text"
                                                class="mt-2 form-input" placeholder="Name:">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-5 lg:col-span-6">
                                        ...
                                        <input name="phone" id="phone" maxlength="12" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" required type="text" class="mt-2 form-input"
                                    ...
                                    <div class="grid grid-cols-1">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <textarea name="content" id="content" required class="mt-2 form-input textarea" placeholder="Message:"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <button type="submit" id="submit"
                                        class="text-white mt-5 rounded-md btn bg-primary hover:bg-secondary">Send
                                        Message</button>
                                </form>
                            </div>
                        </div>
