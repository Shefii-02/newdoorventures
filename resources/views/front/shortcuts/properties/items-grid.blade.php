<div class="row">
                ...
                @foreach ($properties ?? [] as $Pkey => $property)
                    ...
                    @if ($Pkey == 5)
                        <div class="col-lg-12 py-3">
                            @include(
                                'front.shortcuts.ready-to-move-projects',
                                compact('readyToMoveProjects'))
                        </div>
                    @endif
                @endforeach
            </div>
                ...
                <div class="col-lg-12 my-3">
                    @if ($similarProperties->count())
                        <div class="row mt-3">
                            ...
                            @foreach ($similarProperties ?? [] as $Pkey => $property)
                                @if ($property->type == 'pg')
                                    <div class="col-lg-4">
                                        @include('front.shortcuts.properties.item-pg', compact('property'))
                                    </div>
                                @elseif($property->category->name == 'Plot and Land')
                                    <div class="col-lg-4">
                                        @include(
                                            'front.shortcuts.properties.item-plot',
                                            compact('property'))
                                    </div>
                                @elseif($property->type == 'rent')
                                    <div class="col-lg-4">
                                        @include(
                                            'front.shortcuts.properties.item-rent',
                                            compact('property'))
                                    </div>
                                @else
                                    <div class="col-lg-4">
                                        @include(
                                            'front.shortcuts.properties.item-sale',
                                            compact('property'))
                                    </div>
                                @endif
    ...
    <div class="col-lg-2 d-none d-lg-block">
        ...
        @include('front.shortcuts.properties.advertisement', compact('similarProperties', 'properties'))
