...
class FeatureController extends BaseController
{
    public function __construct(protected FeatureInterface $featureRepository)
    {
        ...
        $this
            ->breadcrumb()
            ->add(trans('plugins/real-estate::ameneties.name'), route('property_feature.index'));
    }

    public function index(FeatureTable $dataTable)
    {
        $this->pageTitle(trans('plugins/real-estate::ameneties.name'));
    ...
    {
        $this->pageTitle(trans('plugins/real-estate::ameneties.create'));
    ...
    public function edit(int|string $id, Request $request)
    {
        ...
        $this->pageTitle(trans('plugins/real-estate::ameneties.edit') . ' "' . $feature->name . '"');
