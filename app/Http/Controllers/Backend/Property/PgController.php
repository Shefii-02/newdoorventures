...
use Botble\RealEstate\Forms\Property\PgForm as PropertyForm;
...
use Botble\RealEstate\Tables\Property\PgTable as PropertyTable;
use Carbon\Carbon;
use Exception;
...
class PgController extends BaseController
{
    public function __construct()
    {
        ...
        $this
            ->breadcrumb()
            ->add(trans('plugins/real-estate::property.pg.name'), route('property.pg.index'));
    }

    public function index(PropertyTable $dataTable)
    {
        $this->pageTitle(trans('plugins/real-estate::property.pg.name'));
    ...
    {
        $this->pageTitle(trans('plugins/real-estate::property.pg.create'));
    ...
    public function store(
        ...
        return $this
            ->httpResponse()
            ->setPreviousUrl(route('property.pg.index'))
            ->setNextUrl(route('property.pg.edit', $property->id))
    ...
    public function edit(int|string $id, Request $request)
    {
        ...
        $this->pageTitle(trans('plugins/real-estate::property.pg.edit') . ' "' . $property->name . '"');
