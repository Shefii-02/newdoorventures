...
use Botble\RealEstate\Forms\Property\RentForm as PropertyForm;
...
use Botble\RealEstate\Tables\Property\RentTable as PropertyTable;
use Carbon\Carbon;
use Exception;
...
class RentController extends BaseController
{
    public function __construct()
    {
        ...
        $this
            ->breadcrumb()
            ->add(trans('plugins/real-estate::property.rent.name'), route('property.rent.index'));
    }

    public function index(PropertyTable $dataTable)
    {
        $this->pageTitle(trans('plugins/real-estate::property.rent.name'));
    ...
    {
        $this->pageTitle(trans('plugins/real-estate::property.rent.create'));
    ...
    public function store(
        ...
        $property->furnishing_status = $request->input('furnishing_status') ?? null;
        $property->type = 'rent';
        ...
        return $this
            ->httpResponse()
            ->setPreviousUrl(route('property.rent.index'))
            ->setNextUrl(route('property.rent.edit', $property->id))
    ...
    public function edit(int|string $id, Request $request)
    {
        ...
        $this->pageTitle(trans('plugins/real-estate::property.rent.edit') . ' "' . $property->name . '"');
