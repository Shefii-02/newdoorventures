    ...
    var t,
        e = {
            6410: () => {
                var t = function (t) {
                        void 0 !== t.errors && t.errors.length
                            ...
                            ? void 0 !== t.responseJSON.errors
                                ? 422 === t.status && e(t.responseJSON.errors)
                                : void 0 !== t.responseJSON.message
                                ? i(t.responseJSON.message)
                ...
                window.showAlert = function (t, e) {
                    if (t && "" !== e) {
                        var i = Math.floor(1e3 * Math.random()),
                            n =
                                '<div class="alert '
                                    .concat(t, ' alert-dismissible" id="')
                                    .concat(i, '">\n                        <span class="close cursor-pointer mdi mdi-close-box" aria-label="close"></span>\n                        <i class="') +
                                ("alert-success" === t ? "mdi mdi-check" : "mdi mdi-exclamation") +
                                ' message-icon"></i>\n                        '.concat(e, "\n                    </div>");
                        $("#alert-container")
                            .append(n)
                            .ready(function () {
                ...
                function p(t, e, i) {
                    return (e = g(e)) in t ? Object.defineProperty(t, e, { value: i, enumerable: !0, configurable: !0, writable: !0 }) : (t[e] = i), t;
                }
                function h(t, e) {
                ...
                function f(t, e, i) {
                    return e && v(t.prototype, e), i && v(t, i), Object.defineProperty(t, "prototype", { writable: !1 }), t;
                }
                function g(t) {
                    var e = (function (t, e) {
                ...
                if (
                    ...
                    for (var b = document.getElementById("navigation").getElementsByTagName("a"), w = 0, _ = b.length; w < _; w++)
                        b[w].onclick = function (t) {
                        ...
                        (document.body.scrollTop >= 50 || document.documentElement.scrollTop >= 50
                            ? (t.classList.add("nav-sticky"),
                              $(".breadcrumb").length
                                  ...
                                  : $("#button-language-switcher").removeClass("language-switcher-nav-light"))
                            : (t.classList.remove("nav-sticky-1"),
                              $(".breadcrumb").length ? $("#button-language-switcher").addClass("language-switcher-nav-light") : $("#button-language-switcher").removeClass("language-switcher-nav-light")));
                }
                window.addEventListener("scroll", function (t) {
                    ...
                    (window.onscroll = function () {
                        var t;
                        null != (t = document.getElementById("back-to-top")) &&
                            (document.body.scrollTop > 500 || document.documentElement.scrollTop > 500 ? (t.classList.add("flex"), t.classList.remove("hidden")) : (t.classList.add("hidden"), t.classList.remove("flex")));
                    }),
                    ...
                    (function () {
                        ...
                        if ("" !== t) for (var e = document.querySelectorAll(".sidebar-nav a"), i = 0, n = e.length; i < n; i++) -1 !== e[i].getAttribute("href").indexOf(t) && (e[i].parentElement.className += " active");
                    })(),
                    feather.replace();
                try {
                ...
                try {
                    ...
                    "dark" === s("theme") || "dark" === x || (window.matchMedia("(prefers-color-scheme: dark)").matches && "system" === x)
                        ? ((T.checked = !0), document.documentElement.classList.add("dark"))
                        : ((T.checked = !1), document.documentElement.classList.remove("dark"));
                } catch (t) {}
                try {
                ...
                document.getElementsByClassName("tiny-single-item").length > 0 &&
                    "undefined" != typeof tns &&
                    tns({ container: ".tiny-single-item", items: 1, controls: !1, mouseDrag: !0, loop: !0, rewind: !0, autoplay: !0, autoplayButtonOutput: !1, autoplayTimeout: 3e3, navPosition: "bottom", speed: 400, gutter: 16 }),
                    document.getElementsByClassName("tiny-three-item").length > 0 &&
                        "undefined" != typeof tns &&
                        tns({
                            ...
                            speed: 400,
                            gutter: 16,
                            responsive: { 992: { items: 3 }, 767: { items: 2 }, 320: { items: 1 } },
                        }),
                    document.getElementsByClassName("tiny-three-item-2").length > 0 &&
                        "undefined" != typeof tns &&
                        tns({
                        ...
                        document.getElementsByClassName("tiny-three-item-3").length > 0 &&
                        "undefined" != typeof tns &&
                        tns({
                            container: ".tiny-three-item-3",
                            items: 3,
                            controls: !1,
                            mouseDrag: !0,
                            loop: !1,
                    ...
                    document.getElementsByClassName("tiny-home-slide-three").length > 0 &&
                        "undefined" != typeof tns &&
                        tns({
                ...
                var S = function (t) {
                    document.querySelectorAll(t).length > 0 &&
                        ...
                        tns({
                            ...
                            responsive: { 992: { items: 4 }, 767: { items: 2 }, 320: { items: 1 } },
                        });
                };
                ...
                null === (o = document.getElementsByClassName("back-button")[0]) ||
                    void 0 === o ||
                ...
                try {
                    particlesJS("particles-snow", {
                        particles: {
                            number: { value: 250, density: { enable: !1, value_area: 800 } },
                            color: { value: "#ffffff" },
                            shape: { type: "circle", stroke: { width: 0, color: "#000000" }, polygon: { nb_sides: 36 }, image: { src: "", width: 1e3, height: 1e3 } },
                            opacity: { value: 0.5, random: !1, anim: { enable: !1, speed: 0.5, opacity_min: 1, sync: !1 } },
                            size: { value: 3.2, random: !0, anim: { enable: !1, speed: 20, size_min: 0.1, sync: !1 } },
                            line_linked: { enable: !1, distance: 100, color: "#ffffff", opacity: 0.4, width: 2 },
                            move: { enable: !0, speed: 1, direction: "bottom", random: !1, straight: !1, out_mode: "out", bounce: !1, attract: { enable: !1, rotateX: 800, rotateY: 1200 } },
                        },
                        interactivity: {
                            detect_on: "canvas",
                            ...
                            modes: {
                                ...
                                repulse: { distance: 71, duration: 0.4 },
                                push: { particles_nb: 4 },
                ...
                try {
                    var B = { defaultTabId: null, activeClasses: "text-primary tab-active", inactiveClasses: "hover:text-primary dark:hover:text-white hover:bg-gray-50 dark:hover:bg-slate-800", onShow: function () {} },
                        M = (function () {
                            function t() {
                                        ...
                                        value: function (t) {
                                            ...
                                            (a !== this._activeTab || o) &&
                                                (this._items.map(function (t) {
                                                    var e, i;
                                                    t !== a &&
                                                        ((e = t.triggerEl.classList).remove.apply(e, c(n._options.activeClasses.split(" "))),
                                                        (i = t.triggerEl.classList).add.apply(i, c(n._options.inactiveClasses.split(" "))),
                                                        t.targetEl.classList.add("hidden"),
                                                        t.triggerEl.setAttribute("aria-selected", !1));
                                                }),
                                                (e = a.triggerEl.classList).add.apply(e, c(this._options.activeClasses.split(" "))),
                                                (i = a.triggerEl.classList).remove.apply(i, c(this._options.inactiveClasses.split(" "))),
                                                a.triggerEl.setAttribute("aria-selected", !0),
                        ...
                        document.addEventListener("DOMContentLoaded", function () {
                            document.querySelectorAll("[data-tabs-toggle]").forEach(function (t) {
                                ...
                                t.querySelectorAll('[role="tab"]').forEach(function (t) {
                                    ...
                                    new M(e, { defaultTabId: i });
                            });
                        });
                } catch (t) {}
                try {
                    var j = { placement: "center", backdropClasses: "bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-40", onHide: function () {}, onShow: function () {}, onToggle: function () {} },
                        P = (function () {
                            function t() {
                    ...
                    document.addEventListener("DOMContentLoaded", function () {
                        ...
                        document.querySelectorAll("[data-modal-toggle]").forEach(function (e) {
                            ...
                            var a = null;
                            D(i, t) ? (a = (a = D(i, t)).object) : ((a = new P(n, { placement: o || j.placement })), t.push({ id: i, object: a })),
                ...
                try {
                    var N = { defaultPosition: 0, indicators: { items: [], activeClasses: "bg-white dark:bg-gray-800" }, interval: 6e3, onNext: function () {}, onPrev: function () {}, onChange: function () {} },
                        z = (function () {
                            function t() {
                                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
                                    i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                                h(this, t),
                                    (this._items = e),
                                    (this._options = m(m(m({}, N), i), {}, { indicators: m(m({}, N.indicators), i.indicators) })),
                                    ...
                                    },
                                    {
                                        ...
                                        value: function (t) {
                                            var e,
                                                i,
                                                n = this;
                                            ((this._activeItem = this._items[t]), this._indicators.length) &&
                                                (this._indicators.map(function (t) {
                                                    var e, i;
                                                    t.el.setAttribute("aria-current", "false"),
                                                        (e = t.el.classList).remove.apply(e, c(n._options.indicators.activeClasses.split(" "))),
                                                        (i = t.el.classList).add.apply(i, c(n._options.indicators.inactiveClasses.split(" ")));
                                                }),
                                                (e = this._indicators[t].el.classList).add.apply(e, c(this._options.indicators.activeClasses.split(" "))),
                                                (i = this._indicators[t].el.classList).remove.apply(i, c(this._options.indicators.inactiveClasses.split(" "))),
                        ...
                        document.addEventListener("DOMContentLoaded", function () {
                            document.querySelectorAll("[data-carousel]").forEach(function (t) {
                                ...
                                t.querySelectorAll("[data-carousel-item]").length &&
                                    c(t.querySelectorAll("[data-carousel-item]")).map(function (t, e) {
                                        n.push({ position: e, el: t }), "active" === t.getAttribute("data-carousel-item") && (o = e);
                                    });
                                var a = [];
                                t.querySelectorAll("[data-carousel-slide-to]").length &&
                                    c(t.querySelectorAll("[data-carousel-slide-to]")).map(function (t) {
                                        a.push({ position: t.getAttribute("data-carousel-slide-to"), el: t });
                                    });
                                var s = new z(n, { defaultPosition: o, indicators: { items: a }, interval: e || N.interval });
                                i && s.cycle();
                ...
                try {
                    var H = { alwaysOpen: !1, activeClasses: "bg-gray-50 dark:bg-slate-800 text-primary", inactiveClasses: "text-dark dark:text-white", onOpen: function () {}, onClose: function () {}, onToggle: function () {} },
                        q = (function () {
                            function t() {
                                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
                                    i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                                    ...
                                    },
                                    {
                                        ...
                                        value: function (t) {
                                            ...
                                            this._options.alwaysOpen ||
                                                ...
                                                (e = o.triggerEl.classList).add.apply(e, c(this._options.activeClasses.split(" "))),
                                                (i = o.triggerEl.classList).remove.apply(i, c(this._options.inactiveClasses.split(" "))),
                                    ...
                                    },
                                    {
                                        ...
                                        value: function (t) {
                                            var e,
                                                i,
                                                n = this.getItem(t);
                                            (e = n.triggerEl.classList).remove.apply(e, c(this._options.activeClasses.split(" "))),
                                                (i = n.triggerEl.classList).add.apply(i, c(this._options.inactiveClasses.split(" "))),
                                                n.targetEl.classList.add("hidden"),
                                                n.triggerEl.setAttribute("aria-expanded", !1),
                                                (n.active = !1),
                        ...
                        document.addEventListener("DOMContentLoaded", function () {
                            document.querySelectorAll("[data-accordion]").forEach(function (t) {
                                ...
                                t.querySelectorAll("[data-accordion-target]").forEach(function (t) {
                                    ...
                                    new q(o, { alwaysOpen: "open" === e, activeClasses: i || H.activeClasses, inactiveClasses: n || H.inactiveClasses });
                            });
                        });
                } catch (t) {}
                try {
                    var R = document.getElementById("slider"),
                        J = R.value;
                    (document.getElementById("amount-label").innerHTML = J),
                        (document.getElementById("saving-label").innerHTML = parseFloat(0.01 * J).toFixed(2)),
                        R.addEventListener("input", function () {
                            var t = R.value;
                            (document.getElementById("amount-label").innerHTML = t), (document.getElementById("saving-label").innerHTML = parseFloat(0.01 * t).toFixed(2));
                        });
                } catch (t) {}
                [
                    ...
                    document.getElementById(t.replace("#", "")) && new Choices(t, { allowHTML: !1, searchEnabled: !1 });
                });
                try {
                ...
                try {
                    if (document.getElementById("days"))
                        var U = $("#countdown").find(".time-end").val(),
                            ...
                            G = setInterval(function () {
                                ...
                                (document.getElementById("days").innerHTML = i + "<p class='count-head'>Days</p> "),
                                    (document.getElementById("hours").innerHTML = n + "<p class='count-head'>Hours</p> "),
                                    (document.getElementById("mins").innerHTML = o + "<p class='count-head'>Mins</p> "),
                                    (document.getElementById("secs").innerHTML = a + "<p class='count-head'>Secs</p> "),
                                    e < 0 &&
                                        (clearInterval(G),
                ...
                $(".newsletter-form button[type=submit]").on("click", function (e) {
                    ...
                    $(document).on("click", ".generic-form button[type=submit]", function (e) {
                        ...
                        e.preventDefault(),
                            e.stopPropagation(),
                            $(this).prop("disabled", !0).addClass("button-loading"),
                            $.ajax({
                                type: "POST",
                                cache: !1,
                                ...
                                processData: !1,
                                success: function (t) {
                                    $(o).closest("form").find(".text-success").html("").hide(),
                                        $(o).closest("form").find(".text-danger").html("").hide(),
                                        t.error
                                            ? i(t.message)
                                            : ($(o).closest("form").find("input[type=text]:not([readonly])").val(""),
                                              $(o).closest("form").find("input[type=email]").val(""),
                                              $(o).closest("form").find("input[type=number]").val(""),
                                              $(o).closest("form").find("input[type=url]").val(""),
                                              $(o).closest("form").find("input[type=tel]").val(""),
                                              $(o).closest("form").find("select").val(""),
                                              $(o).closest("form").find("textarea").val(""),
                                              n(t.message),
                                              t.data && t.data.next_page && (window.location.href = t.data.next_page)),
                ...
                Z.length &&
                    Z.each(function (t, e) {
                        !(function (t) {
                            var e = t.data("uid");
                            e || ((e = (Math.random() + 1).toString(36).substring(7) + new Date().getTime()), t.data("uid", e)),
                                propertyMaps[e] && (propertyMaps[e].off(), propertyMaps[e].remove()),
                                (propertyMaps[e] = L.map(t[0], { zoomControl: !1, scrollWheelZoom: !0, dragging: !0, maxZoom: t.data("max-zoom") || 20 }).setView(t.data("center"), t.data("zoom") || 14));
                            var i = L.divIcon({ className: "boxmarker", iconSize: L.point(50, 20), html: t.data("map-icon") });
                            L.tileLayer(t.data("tile-layer") ? t.data("tile-layer") : "https://mt0.google.com/vt/lyrs=m&hl=en&x={x}&y={y}&z={z}").addTo(propertyMaps[e]),
                                L.marker(t.data("center"), { icon: i }).addTo(propertyMaps[e]).bindPopup(t.find(".property-template-popup-map").html()).openPopup();
                        })($(e));
                    }),
                ...
                !(function () {
                    ...
                    if (e) {
                        ...
                        if ((null != i && i.length > 0 && (n = JSON.parse(s(t))), 0 !== e && void 0 !== e)) {
                            ...
                            if (null == i || "" === i) n.push(o), a(t, JSON.stringify(n), 60);
                                ...
                                var l = (n = JSON.parse(i))
                                    .map(function (t) {
                                        return t.id;
                                    })
                                    .indexOf(o.id);
                                -1 === l ? (n.length >= 20 && n.shift(), n.push(o), r(t), a(t, JSON.stringify(n), 60)) : (n.splice(l, 1), n.push(o), r(t), a(t, JSON.stringify(n), 60));
                            }
                        }
                    }
                })(),
                    $("#map").length &&
                        (function () {
                            ...
                            if (t.length && (!$(".view-type-map").length || $(".view-type-map").hasClass("active"))) {
                                ...
                                var s = L.map("map", { zoomControl: !0, scrollWheelZoom: !0, dragging: !0, maxZoom: t.data("max-zoom") || 18 }).setView(o, 14);
                                                    ...
                                                    t.data.length > 0 &&
                                                        (t.data.forEach(function (t) {
                                                            if (t.latitude && t.longitude) {
                                                                var e = L.divIcon({ className: "boxmarker", iconSize: L.point(50, 20), html: t.map_icon }),
                                                                    i = (function (t, e) {
                                                                        var i = Object.keys(t);
                                                                        for (var n in i)
                                                                    ...
                                                                    n = new L.Marker(new L.LatLng(t.latitude, t.longitude), { icon: e }).bindPopup(i).addTo(s);
                                                                l.push(n),
                                                                    r.addLayer(n),
                                                                    s.flyToBounds(
                                                                        L.latLngBounds(
                    ...
                    $("#navigation").find($(".nav-light")).length ? $("#button-language-switcher").addClass("language-switcher-nav-light") : $("#button-language-switcher").removeClass("language-switcher-nav-light"),
